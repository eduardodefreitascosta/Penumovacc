...
a<-ggplot(data=db,aes(x=year,y=flt01,colour=as.factor(vac)))+
  geom_point()+
  annotate("text",x=db$year[103], y=max(db$flt01)+30, label= "2010",size=2.8)+
...
b<-ggplot(data=db,aes(x=year,y=f0104,colour=as.factor(vac)))+
  geom_point()+
  annotate("text",x=db$year[103], y=max(db$f0104)+30, label= "2010",size=2.8)+
  #geom_smooth(method = "lm") +
  geom_rect(data=db,aes(xmin = year[97], xmax = year[109], ymin = -Inf, ymax = Inf),
            fill = "lightgray", alpha = 0.02,linetype=0)+
            xlab("Time (years)") + 
...
c<-ggplot(data=db,aes(x=year,y=f0509,colour=as.factor(vac)))+
  ...
  annotate("text",x=db$year[103], y=max(db$f0509)+5, label= "2010",size=2.8)+
  #geom_smooth(method = "lm") +
  geom_rect(data=db,aes(xmin = year[97], xmax = year[109], ymin = -Inf, ymax = Inf),
            fill = "lightgray", alpha = 0.02,linetype=0)+
            xlab("Time (years)") + 
...
d<-ggplot(data=db,aes(x=time_line,y=f1019,colour=as.factor(vac)))+
  geom_point()+
  geom_jitter(width = 0.5)+
  annotate("text",x=db$time_line[102], y=max(db$f1019)+2, label= "2010",size=2.8)+
  geom_smooth(method = "lm") +
...
e<-ggplot(data=db,aes(x=time_line,y=f2059,colour=as.factor(vac)))+
  geom_point()+
  geom_jitter(width = 0.5)+
  annotate("text",x=db$time_line[102], y=max(db$f2059)+2, label= "2010",size=2.8)+
  geom_smooth(method = "lm") +
  geom_rect(data=db,aes(xmin = time_line[96], xmax = time_line[108], ymin = -Inf, ymax = Inf),
            fill = "lightgray", alpha = 0.02,linetype=0)+
            xlab("Time (years)") + 
...
f<-ggplot(data=db,aes(x=time_line,y=f6079,colour=as.factor(vac)))+
  geom_point()+
  geom_jitter(width = 0.5)+
  annotate("text",x=db$time_line[102], y=max(db$f6079)+2, label= "2010",size=2.8)+
  geom_smooth(method = "lm") +
  geom_rect(data=db,aes(xmin = time_line[96], xmax = time_line[108], ymin = -Inf, ymax = Inf),
            fill = "lightgray", alpha = 0.02,linetype=0)+
            xlab("Time (years)") + 
...
g<-ggplot(data=db,aes(x=time_line,y=fmm80,colour=as.factor(vac)))+
  geom_point()+
  geom_jitter(width = 0.5)+
  annotate("text",x=db$time_line[102], y=max(db$fmm80)+2, label= "2010",size=2.8)+
  geom_smooth(method = "lm") +
  geom_rect(data=db,aes(xmin = time_line[96], xmax = time_line[108], ymin = -Inf, ymax = Inf),
            fill = "lightgray", alpha = 0.02,linetype=0)+
            xlab("Time (years)") + 
